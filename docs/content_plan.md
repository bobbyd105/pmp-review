...
- Phase 2 depth round 1 added 10 Process questions and 7 People questions;
  ...
  26 questions (q271–q296), exactly one per ECO task.
...
|---|---|---|---|---|
| People | 33% | 8 | 96 | 8 |
| Process | 41% | 10 | 120 | 10 |
| Business Environment | 26% | 8 | 80 | 8 |
| **Total** | **100%** | **26** | **296** | **26** |
...
|---|---|---|---|---|
| People | Task 1: Develop a common vision | 12 | 1 | Q+L |
| People | Task 2: Manage conflicts | 12 | 1 | Q+L |
| People | Task 3: Lead the project team | 12 | 1 | Q+L |
| People | Task 4: Engage stakeholders | 12 | 1 | Q+L |
| People | Task 5: Align stakeholder expectations | 12 | 1 | Q+L |
| People | Task 6: Manage stakeholder expectations | 12 | 1 | Q+L |
| People | Task 7: Help ensure knowledge transfer | 12 | 1 | Q+L |
| People | Task 8: Plan and manage communication | 12 | 1 | Q+L |

## Process (10 tasks, 41%)

| Domain | Task | Questions | Lessons | Status |
|---|---|---|---|---|
| Process | Task 1: Develop an integrated project management plan and plan delivery | 12 | 1 | Q+L |
| Process | Task 2: Develop and manage project scope | 12 | 1 | Q+L |
| Process | Task 3: Help ensure value-based delivery | 12 | 1 | Q+L |
| Process | Task 4: Plan and manage resources | 12 | 1 | Q+L |
| Process | Task 5: Plan and manage procurement | 12 | 1 | Q+L |
| Process | Task 6: Plan and manage finance | 12 | 1 | Q+L |
| Process | Task 7: Plan and optimize quality of products/deliverables | 12 | 1 | Q+L |
| Process | Task 8: Plan and manage schedule | 12 | 1 | Q+L |
| Process | Task 9: Evaluate project status | 12 | 1 | Q+L |
| Process | Task 10: Manage project closure | 12 | 1 | Q+L |

## Business Environment (8 tasks, 26%)

| Domain | Task | Questions | Lessons | Status |
|---|---|---|---|---|
| Business Environment | Task 1: Define and establish project governance | 10 | 1 | Q+L |
| Business Environment | Task 2: Plan and manage project compliance | 10 | 1 | Q+L |
| Business Environment | Task 3: Manage and control changes | 10 | 1 | Q+L |
| Business Environment | Task 4: Remove impediments and manage issues | 10 | 1 | Q+L |
| Business Environment | Task 5: Plan and manage risk | 10 | 1 | Q+L |
| Business Environment | Task 6: Continuous improvement | 10 | 1 | Q+L |
| Business Environment | Task 7: Support organizational change | 10 | 1 | Q+L |
| Business Environment | Task 8: Evaluate external business environment changes | 10 | 1 | Q+L |
...
- **Breadth: complete.** All 26 tasks now have at least one question and at
  ...
  remain.
- **Question depth:** every People and Process task has 12 questions. Every
  Business Environment task has 10.
